...
VISUALISATION_SETTINGS = {
    'Consulta original': {'color': '#bfff00', 'opacity': 1, 'symbol': 'cross', 'size': 15},
    'Chunks recuperados': {'color': '#30ff24', 'opacity': 1, 'symbol': 'circle', 'size': 10},
    'Chunks': {'color': '#00c1d3', 'opacity': 0.4, 'symbol': 'circle', 'size': 10},
